...
#file = open('./emofiel_text/Harry_Potter_and_the_Philosopher%27s_Stone.resolved.txt', 'r')
#file = open('./emofiel_text/Harry_Potter_and_the_Chamber_of_Secrets.resolved.txt', 'r')
file = open('./emofiel_text/Harry_Potter_and_the_Prisoner_of_Azkaban.resolved.txt', 'r')
#file = open('./emofiel_text/Harry_Potter_and_the_Goblet_of_Fire.resolved.txt', 'r')
#file = open('./emofiel_text/Harry_Potter_and_the_Half-Blood_Prince.resolved.txt', 'r')
#file = open('./emofiel_text/Harry_Potter_and_the_Order_of_the_Phoenix.resolved.txt', 'r')
#file = open('./emofiel_text/Harry_Potter_and_the_Deathly_Hallows.resolved.txt', 'r')
...
storygraph = []
with open("storygraph_v3.csv",'w') as resultFile:
